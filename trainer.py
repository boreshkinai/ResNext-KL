...
flags.DEFINE_integer('number_of_steps', 960000, 'Number of steps to train a column')
flags.DEFINE_integer('save_summaries_secs', 5, 'Time between savnum_samples_evaling summaries')
...
flags.DEFINE_string('mode', 'eval', "Execution mode in {'train', 'eval'}.")
